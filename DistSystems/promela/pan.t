...
{	Trans *T;
	...
	trans[1][1]	= settr(7,0,2,3,3,"(run division(7,3,0,child))", 1, 2, 0);
	trans[1][2]	= settr(8,0,3,4,4,"child?q,r", 1, 504, 0);
	trans[1][3]	= settr(9,0,4,5,0,"printf('Result: %d %d\\n',q,r)", 0, 2, 0);
	trans[1][4]	= settr(10,0,0,6,6,"-end-", 0, 3500, 0);
	...
	trans[0][1]	= settr(0,0,2,7,7,"((y>x))", 0, 2, 0);
	trans[0][2]	= settr(1,0,7,8,8,"res!q,x", 1, 3, 0);
	trans[0][6]	= settr(5,0,7,1,0,".(goto)", 0, 2, 0);
	trans[0][3]	= settr(2,0,4,9,0,"((x>=y))", 0, 2, 0);
	trans[0][4]	= settr(3,0,7,10,10,"(run division((x-y),y,(q+1),res))", 1, 2, 0);
	trans[0][7]	= /* c */ settr(6,0,0,6,6,"-end-", 0, 3500, 0);
	/* np_ demon: */
