...
/**
* Dealing/buysHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from dealing.idl
* Friday, 26 November 2010 16:43:44 o'clock GMT
*/

abstract public class buysHelper
{
  private static String  _id = "IDL:Dealing/buys:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (Dealing.buysHelper.id (), "buys", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static Dealing.b[] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = new Dealing.b[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = Dealing.buyHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, Dealing.b[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      Dealing.buyHelper.write (ostream, value[_i0]);
  }
